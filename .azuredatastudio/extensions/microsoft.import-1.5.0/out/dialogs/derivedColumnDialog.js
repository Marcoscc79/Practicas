...
exports.DerivedColumnDialog = void 0;
/*---------------------------------------------------------------------------------------------
...
class DerivedColumnDialog {
    constructor(_model, _provider) {
        this._model = _model;
        this._provider = _provider;
        this._doneEmitter = new EventEmitter();
        this._currentTransformation = [];
        this._specifyTransformations = [];
    }
    createDerivedColumn() {
        this._applyButton = azdata.window.createButton(constants.previewTransformation);
        this._applyButton.enabled = false;
        this._dialogObject = azdata.window.createModelViewDialog(constants.createDerivedColumn, 'DerivedColumnDialog', 'wide');
        ...
        tab.registerContent(async (view) => {
            ...
            this._model.originalProseColumns.forEach(c => {
                const tableRow = [];
                tableRow.push({ value: false, ariaLabel: constants.selectColumn(c.columnName) }, { value: c.columnName });
                ...
                if (transExamples.length > 0) {
                    try {
                        ...
                        this._currentTransformation.forEach((v, i) => {
                            this._transformationTable.dataValues[i][0].value.placeHolder = v;
                        });
    ...
    clearAndAddTransformationContainerComponents(addTable) {
...
exports.DerivedColumnDialog = DerivedColumnDialog;
//# sourceMappingURL=https://sqlopsbuilds.blob.core.windows.net/sourcemaps/626eecf964d392704e8203067080127bb7607dc9/extensions/import/out/dialogs/derivedColumnDialog.js.map
