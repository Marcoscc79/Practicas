...
class FlatFileImportFeature extends dataprotocol_client_1.SqlOpsFeature {
    ...
    registerProvider(options) {
        ...
        let sendLearnTransformationRequest = (params) => {
            return requestSender(Contracts.LearnTransformationRequest.type, params);
        };
        let sendSaveTransformationRequest = (params) => {
...
//# sourceMappingURL=https://sqlopsbuilds.blob.core.windows.net/sourcemaps/626eecf964d392704e8203067080127bb7607dc9/extensions/import/out/services/features.js.map
