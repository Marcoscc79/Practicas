...
exports.getAzureAccounts = exports.TestFlatFileProvider = exports.TestImportDataModel = exports.TestExtensionContext = exports.TestQueryProvider = exports.ImportTestUtils = void 0;
...
class TestQueryProvider {
    ...
    connectionUriChanged(newUri, oldUri) {
        throw new Error('Method not implemented.');
    }
...
class TestFlatFileProvider {
    ...
    sendLearnTransformationRequest(params) {
        throw new Error('Method not implemented.');
    }
    sendSaveTransformationRequest(params) {
        throw new Error('Method not implemented.');
    }
}
exports.TestFlatFileProvider = TestFlatFileProvider;
function getAzureAccounts() {
    return [
        {
            isStale: false,
            key: {
...
//# sourceMappingURL=https://sqlopsbuilds.blob.core.windows.net/sourcemaps/626eecf964d392704e8203067080127bb7607dc9/extensions/import/out/test/utils.test.js.map
