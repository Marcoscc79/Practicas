...
class FileConfigPage extends importPage_1.ImportPage {
    ...
    async createFileBrowser() {
        this.fileTextBox = this.view.modelBuilder.inputBox().withProps({
            ...
            if (component.value) {
                try {
                    await fs_1.promises.access(component.value);
                    return true;
                }
                catch (e) {
                    return false;
...
//# sourceMappingURL=https://sqlopsbuilds.blob.core.windows.net/sourcemaps/626eecf964d392704e8203067080127bb7607dc9/extensions/import/out/wizard/pages/fileConfigPage.js.map
